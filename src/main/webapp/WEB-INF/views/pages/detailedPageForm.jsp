        ...
        <body>
            ...
            <form action="write" enctype="multipart/form-data" method="POST" onsubmit="return writeValidate()">
                <main id="detailed">
                    <section class="upper">
                        <div class="upperWrapper">
                            ...
                            <div class="classInfo">
                                <div class="classCategory">
                                    <select name="mainCategory" id="mainCategory">
                                        <c:if test="${!empty classInfo.main}">
                                            <option value="${classInfo.main}" selected>${classInfo.main}</option>
                                        </c:if>
                                        <c:if test="${empty classInfo.main}">
                                    ...
                                    <select name="subCategory" id="subCategory">
                                        <c:if test="${!empty classInfo.sub}">
                                            <option value="${classInfo.sub}" selected>${classInfo.sub}</option>
                                        </c:if>
                                        <c:if test="${empty classInfo.sub}">
                                ...
                                <div class="classTitle"><input type="text" class="inputBox" id="inputTtile1"
                                        name="classTitle" placeholder="클래스 제목" value="${classInfo.className}"></div>
                    ...
                    <section class="lower">
                        <div class="introduceBox" id="classIntroduce">
                            <section class="classDetailBox">
                                <div class="urlBox">
                                    <h3>강의 URL</h3><input type="text" class="inputBox" name="classUrl" id="url"
                                        value="${classInfo.classUrl }">
                                </div>
                                <div class="classDetail">
                                    <textarea class="classDetailContent" name="classContent"
                                        id="textarea">${classInfo.classIntro }</textarea>
                            ...
                            <section id="detailedSide-d1">
                                <div>
                                    ...
                                    <div class="classEvaluation"><span class="star">★</span> (5) / <span><i
                                                class="fa-solid fa-users"></i> 100</span></div>
                                    <div class="classTeacher">${tutorInfo[2]} 튜터</div>
                                    <input type="text" class="inputBox" id="classPrice" name="classPrice"
                                        placeholder="금액" value=${classInfo.classPrice }>원
                                </div>
                    ...
                    <%-- <input type="hidden" name="categoryCode" value="${classInfo.categoryCode}"> --%>
                </main>
            </form>
            <script>
