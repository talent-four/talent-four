                ...
                <main id="detailed">
                    <section class="upper">
                        <div class="upperWrapper">
                            ...
                            <div class="classInfo">
                                <div class="classCategory"><span>${classInfo.main}</span> /
                                    <span>${classInfo.sub}</span></div>
                                <div class="classTitle">${classInfo.className}</div>
                                <div class="classEvaluation"><span class="star">★</span> (${classInfo.score}) / <span><i
                                            class="fa-solid fa-users"></i> ${classInfo.reviews}</span></div>
                                ...
                                <c:forEach var="item" items="${reviewList}">
                                    <div class="d-review">
                                        ...
                                        <div class="reviewBtnArea">
                                            <button onclick="thumbsBtn()"><i class="fa-regular fa-thumbs-up"></i>
                                                ${item.thumbs}</button>
                                            <button onclick="reportBtn()"><i class="fi fi-sr-light-emergency-on"></i>
                                                ${item.report}</button>
                                        </div>
                                    </div>
                                </c:forEach>
                        ...
                        <section id="detailedSide" class="bottomBox">
                            <section id="detailedSide-d1">
                                <div>
                                    ...
                                    <span><strong>
                                            <fmt:formatNumber value="${classInfo.classPrice}" pattern="#,###원" />
                                        </strong></span><br>
                                </div>
