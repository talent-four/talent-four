                    ...
                    <div id="month12">
                        ...
                        <section>
                            <div id="creditS">
                                ...
                                <label><input type="radio" name="creditSelect"> 네이버페이 <img
                                        src="${contextPath}/resources/img/nPay.png" class="imgPay"></label>
                                <label><input type="radio" name="creditSelect"> 카카오페이 <img
                        ...
                        <td>99,000원</td>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <button id="btnCredit" onclick="requestPay()">결제하기</button>
                                    </td>
                                </tr>
                            </table>
