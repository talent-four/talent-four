...
ALTER TABLE "STUDYBOARD" ADD CONSTRAINT "PK_STUDYBOARD" PRIMARY KEY ("BOARD_NO");
ALTER TABLE "TUTOR" ADD CONSTRAINT "PK_TUTOR" PRIMARY KEY ("MEMBER_NO");
ALTER TABLE "BOARD_TYPE" ADD CONSTRAINT "PK_BOARD_TYPE" PRIMARY KEY ("BOARD_CD");

ALTER TABLE "BOARD" ADD CONSTRAINT "PK_BOARD" PRIMARY KEY ("BOARD_NO");

ALTER TABLE "HASHTAG" ADD CONSTRAINT "PK_HASHTAG" PRIMARY KEY ("TAG_NO");
...
-- FK 드랍
ALTER TABLE REVIEW
DROP CONSTRAINT FK_BOARD_TO_REVIEW_1;
...
-- 시퀀스 만들어야할듯
DROP SEQUENCE CATEGORY_MAIN_SEQ;
DROP SEQUENCE CATEGORY_SUB_SEQ;

CREATE SEQUENCE CATEGORY_MAIN_SEQ;
...
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '프로그래밍 언어', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '개발·프로그래밍'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '알고리즘', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '개발·프로그래밍'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '자료구조', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '개발·프로그래밍'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '데이터베이스', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '개발·프로그래밍'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '소프트웨어 테스트', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '개발·프로그래밍'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '개발 도구', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '개발·프로그래밍'));


INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '프론트엔드', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '웹 개발'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '백엔드', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '웹 개발'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, 'JavaScripit', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '웹 개발'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, 'HTML/css', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '웹 개발'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, 'React', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '웹 개발'));

INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '게임 프로그래밍', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '게임 개발'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '게임 기획', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '게임 개발'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '게임 아트·그래픽', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '게임 개발'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '기타(게임 개발)', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '게임 개발'));

INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '데이터 분석', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '데이터 사이언스'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '데이터 엔지니어링', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '데이터 사이언스'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '자격증(데이터 사이언스)', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '데이터 사이언스'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '기타(데이터 사이언스)', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '데이터 사이언스'));

INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, 'AI·ChatGPT 활용', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '인공지능'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '딥러닝·머신러닝', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '인공지능'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '컴퓨터 비전', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '인공지능'));
INSERT INTO CATEGORY VALUES ('SUB_'||CATEGORY_SUB_SEQ.NEXTVAL, '자연어 처리', (SELECT CATEGORY_CODE FROM CATEGORY WHERE CATEGORY_NAME = '인공지능'));
...
WHERE CATEGORY_CODE = 'MAIN_1';

SELECT C.*, M.MEMBER_NM
FROM CLASS C
JOIN MEMBER M ON C.MEMBER_NO = M.MEMBER_NO;

SELECT CT.PARENT_ID, C.* ,M.MEMBER_NM
FROM CATEGORY CT
JOIN CLASS C ON CT.CATEGORY_CODE = C.CATEGORY_CODE
